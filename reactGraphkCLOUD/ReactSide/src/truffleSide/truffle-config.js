...
let web3 = new Web3(Web3.givenProvider || function(){
 ...
 return new HDWalletProvider(mnemonic, "https://ropsten.infura.io/v3/f54c17f8fd334d78bcb2117202fe7ce0", 0)
});
...
module.exports = {
  ...
  networks: {
    ...
    gasPrice: web3.utils.toWei("100","gwei"),        // Ropsten has a lower block limit than mainnet
